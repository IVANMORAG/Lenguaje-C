...
int main() {
    ...
    // Bloque para imprimir números divisibles entre 3 mayores a 0 y menores a mil
    ...
    // Bloque para imprimir números divisibles entre 2 y 7 mayores a 0 y menores a mil
    ...
    // Bloque para imprimir enteros positivos menores que 100 no divisibles por 7
